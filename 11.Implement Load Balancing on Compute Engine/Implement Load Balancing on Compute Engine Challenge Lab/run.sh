...
# Input FIREWALL
if [[ -z "$FIREWALL" ]]; then
    read -p "Input FIREWALL: " FIREWALL
fi
...
# Export env
export INPUT_ERROR="${RED}Errors: Please setup INSTANCE, FIREWALL, ZONE env before run script.${RESET}"

export INSTANCE FIREWALL ZONE
