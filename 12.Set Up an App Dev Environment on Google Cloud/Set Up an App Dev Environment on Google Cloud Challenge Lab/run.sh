...
# Input FUNCTION
if [[ -z "$FUNCTION" ]]; then
    read -p "Input FUNCTION: " FUNCTION
fi

# Export env
export INPUT_ERROR="${RED}Errors: Please setup USER_2, ZONE, TOPIC, FUNCTION env before run script.${RESET}"

export USER_2 ZONE TOPIC FUNCTION
